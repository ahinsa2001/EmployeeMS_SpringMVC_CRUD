...
<%--&lt;%&ndash;<html>&ndash;%&gt;--%>
<%--&lt;%&ndash;<head>&ndash;%&gt;--%>
<%--&lt;%&ndash;    <title>Register</title>&ndash;%&gt;--%>
...
<%--&lt;%&ndash;        }&ndash;%&gt;--%>
<%--&lt;%&ndash;        input[type="text"], input[type="password"], input[type="email"] {&ndash;%&gt;--%>
<%--&lt;%&ndash;            width: 100%;&ndash;%&gt;--%>
...
<%--&lt;%&ndash;</head>&ndash;%&gt;--%>
<%--&lt;%&ndash;<body>&ndash;%&gt;--%>
<%--&lt;%&ndash;<h2>Register</h2>&ndash;%&gt;--%>
<%--&lt;%&ndash;<form:form method="post" modelAttribute="user">&ndash;%&gt;--%>
...
<%--&lt;%&ndash;    <form:input path="email" placeholder="Email" /><br/>&ndash;%&gt;--%>
<%--&lt;%&ndash;    <input type="submit" value="Register"/>&ndash;%&gt;--%>
<%--&lt;%&ndash;</form:form>&ndash;%&gt;--%>
<%--&lt;%&ndash;<div class="account-link">&ndash;%&gt;--%>
<%--&lt;%&ndash;    <p>Do you have an account? <a href="login">Log in</a></p>&ndash;%&gt;--%>
<%--&lt;%&ndash;</div>&ndash;%&gt;--%>
<%--&lt;%&ndash;</body>&ndash;%&gt;--%>
<%--&lt;%&ndash;</html>&ndash;%&gt;--%>
...
<%--    <form:form method="post" action="register" onsubmit="return validateRegisterForm()">--%>
...
<%--        </div>--%>
<%--        <div class="form-group">--%>
<%--            <p>Already have an account? <a href="login" style="color: #F05941;">Login here</a></p>--%>
<%--        </div>--%>
<%--    </form:form>--%>
<%--</div>--%>
<%--</body>--%>
...
<div class="form-container">
    <form:form method="post" modelAttribute="user" onsubmit="return validateRegistrationForm()">
        <div class="form-group">
        ...
        <div class="form-group">
            <form:input path="email" placeholder="Email" id="email" onfocus="clearError(event)"/>
            <div id="emailError" class="error"></div>
        </div>
        <div class="form-group">
            <input type="submit" value="Register"/>
